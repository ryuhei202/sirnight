    ...
    <div className="bg-clay py-28" id="faq">
      ...
      <div className="border-b-2 border-solid border-[#D8D8D2]">
        <QuestionAnswer
          ...
          answer={
            <>
              UWearはプロのデザイナー監修のもと、服づくりをしています。
              <br />
              お届けする服の多くがオリジナルブランドです。すべて利用シーンにあわせた自信のあるオリジナルアイテムをお届けしています。
            </>
          }
        />
        <QuestionAnswer
        ...
        <QuestionAnswer
          ...
          answer={
            <>
              返却は「コンビニ返却」「ヤマト集荷」「PUDO」があります。コンビニ返却の場合、伝票なしでUWearのLINE画面のバーコードを見せるだけで返却ができます。
            </>
          }
        />
        <QuestionAnswer
          ...
          answer={
            <>
              服を安心してお使いいただけるよう、服の汚れはUWearにて「修復」「クリーニング」しています。ご安心ください。ただ返却アイテムの再利用できない汚れが続いた場合は、ご連絡をさせて頂き、次回より服の買取をお願いする場合があります。
            </>
          }
        />
        <QuestionAnswer
