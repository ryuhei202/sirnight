  ...
  return (
    <div className="h-fit" id="coordinates">
      ...
      <CoordinateCard
        ...
        ゆとりのあるシルエットのボトムスで窮屈すぎない過ごしやすいコーデにしました。スモーキーなピンクのシャツは色の彩度を抑えているので柔らかく優しい印象になります。
        ...
        <>
          <div className="animate-fadeIn">
            ...
            <CoordinateCard
              ...
              サマーニットは生地がさらりとしており肌離れが良く、ボトムスにはショートパンツを合わせると涼しく着て頂けるので子どもと一緒に遊ぶシーンでもおすすめです。
              濃いブルーのトップスは、カラーの中でもトーンが暗めなので落ち着いた印象に見え、安心感のあるお父さんコーデにしました。足元はスニーカーを合わせて沢山動き回れるようにしています。"
            />
          </div>
        </>
      ) : (
